...
export const poeWebModelKeys = [
  'poeAiWebSage',
  'poeAiWebGPT4',
  'poeAiWebClaudeTwo100k',
  'poeAiWebClaudeInstant',
  'poeAiWebClaude100k',
  'poeAiWebCustom',
  'poeAiWebChatGpt',
  'poeAiWebGooglePaLM',
...
export const Models = {
  ...
  poeAiWebClaudeTwo100k: { value: 'Claude-2-100k', desc: 'Poe AI (Web, Claude-2-100k)' },
  poeAiWebClaudeInstant: { value: 'Claude-instant', desc: 'Poe AI (Web, Claude-instant)' },
